...
void ssd1306_WriteData(uint8_t* buffer, size_t buff_size) {
    ...
    for (int i = 0; i < buff_size; i++) { ssd1306_writeByte(0x40, buffer[i]); }
}
void ssd1306_writeByte(uint16_t address, uint8_t byte) {
    volatile uint16_t timeout = 0x1FFF;
...
void ssd1306_Init(void) {
    ...
    for (volatile int i = 0; i < 144 * 1000000 / 10; i++) {}
