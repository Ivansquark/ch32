...
#define  ADC_BUFEN                      ((uint32_t)0x04000000)        /* buffer enable */
...
#define  FLASH_STATR_WR_BSY                    ((uint8_t)0x02)               /* Busy */
...
#define  RCC_IOPEEN                      ((uint32_t)0x00000040)         /* I/O port D clock enable */
...
#define  RCC_DACEN                       ((uint32_t)0x20000000)        /* Dac interface clock enable */
