...
#define USBHSD_UEP_RXDMA(N)                                                    \
    (*((volatile uint32_t*)(USBHSD_UEP_RXDMA_BASE + (N - 1) * 0x04)))
#define USBHSD_UEP_RXBUF(N)                                                    \
    ((uint8_t*)(*(                                                             \
         (volatile uint32_t*)(USBHSD_UEP_RXDMA_BASE + (N - 1) * 0x04))) +      \
     0x20000000)
#define USBHSD_UEP_TXCTRL(N)                                                   \
    (*((volatile uint8_t*)(USBHSD_UEP_TXCTL_BASE + (N - 1) * 0x04)))
#define USBHSD_UEP_TXDMA(N)                                                    \
    (*((volatile uint32_t*)(USBHSD_UEP_TXDMA_BASE + (N - 1) * 0x04)))
#define USBHSD_UEP_TXBUF(N)                                                    \
    ((uint8_t*)(*(                                                             \
         (volatile uint32_t*)(USBHSD_UEP_TXDMA_BASE + (N - 1) * 0x04))) +      \
     0x20000000)
#define USBHSD_UEP_TLEN(N)                                                     \
    (*((volatile uint16_t*)(USBHSD_UEP_TXLEN_BASE + (N - 1) * 0x04)))
