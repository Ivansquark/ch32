...
template <IRQn_Type irq> class InterruptManagerForObjects {
  public:
    void setVector() { InterruptManager::addHandler(interruptsHandler, irq); }
    ...
    static constexpr uint8_t SIZE_OF_ARR_OF_CLASSES = 3;
    static Interruptable* arrayOfInterruptClasses[SIZE_OF_ARR_OF_CLASSES];
};

template <IRQn_Type irq>
Interruptable* InterruptManagerForObjects<
    irq>::arrayOfInterruptClasses[SIZE_OF_ARR_OF_CLASSES] = {nullptr};
#endif // IRQ_H
