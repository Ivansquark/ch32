...
void USBHD_IRQHandler() __attribute__((weak, alias("Default_Handler")));
void USBHDWakeUp_IRQHandler() __attribute__((weak, alias("Default_Handler")));
...
void (*vectors[])() __attribute__((section(".vector"))) = {
    ...
    USBHD_IRQHandler,           /* USBHD global Interrupt */
    USBHDWakeUp_IRQHandler,     /* USB Host/Device WakeUp Interrupt */
    UART4_IRQHandler,           /* UART4 */
    DMA1_Channel8_IRQHandler,   /* DMA2 Channel 8 */
};
// from linker
